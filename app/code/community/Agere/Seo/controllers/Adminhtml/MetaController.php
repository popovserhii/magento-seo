 ...
 */
class Agere_Seo_Adminhtml_MetaController extends Mage_Adminhtml_Controller_Action {
	...
	public function editAction() {
		...
		$model = Mage::getModel('agere_seo/rule')->load($id);
	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			try {
				...
				/** @var Agere_Seo_Model_MetaTag_Factory $factory */
				$factory = Mage::getModel('agere_seo/metaTag_factory');
				...
				$model = Mage::getModel('agere_seo/rule');
	...
	public function deleteAction() {
		if ($id = $this->getRequest()->getParam('id')) {
			try {
				Mage::getModel('agere_seo/meta')->setId($id)->delete();
	...
	protected function _initAction() {
		$this->loadLayout()
			...
			->_setActiveMenu('agere_seo/agere_seo_meta')
	...
	protected function _isAllowed()	{
		return Mage::getSingleton('admin/session')->isAllowed('agere_seo/agere_seo_meta');
	}
