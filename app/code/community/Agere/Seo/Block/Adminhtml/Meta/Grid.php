 ...
 */
class Agere_Seo_Block_Adminhtml_Meta_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	...
	protected function _prepareCollection() {
		/** @var Agere_Seo_Model_Resource_Rule_Collection $collection */
		$collection = Mage::getModel('agere_seo/rule')->getCollection();
