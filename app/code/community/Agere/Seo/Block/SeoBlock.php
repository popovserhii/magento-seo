 ...
 */
class Agere_Seo_Block_SeoBlock extends Mage_Core_Block_Template {

	/**
	 * @param null|array $params
	 * @return Agere_Seo_Model_Resource_Seoblock_Collection|string
	 */
	public function getSeoText($params = null) {
		/** @var Agere_Seo_Model_Seoblock $seoBlockModel */
		$seoBlockModel = Mage::getModel('agere_seo/seoblock');
